...
*   **New code coverage** over existing coverage across all targets in OSS-Fuzz for the same project. 
...
The prompt of the code fixing query is structured as follows, where the raw\_code and error are respectively replaced with the fuzz target source code generated by the LLM and the build error messages extracted from pages of build logs:LL
...
<https://storage.googleapis.com/oss-fuzz-llm-targets-public/tinyxml2-tinyxml2-xmldocument-print/fixes/04-F4/prompt.txt>

After fix: Correct function argument added.

<https://storage.googleapis.com/oss-fuzz-llm-targets-public/tinyxml2-tinyxml2-xmldocument-print/fixes/04-F4/01.cpp>
