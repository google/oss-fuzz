...
def run_experiment(project_name, target_name, args, output_path, errlog_path,
                   ...
                   use_cached_image, real_project_name=None):
...
def main():
  ...
  parser.add_argument('--real_project',
                      required=False,
                      default='',
                      help=(
                        'The real OSS-Fuzz project name (e.g. if `--project` '
                        'is an autogenerated project name).'))
  args = parser.parse_args()

  run_experiment(args.project, args.target, args.args, args.upload_output_log,
                 args.upload_err_log, args.upload_build_log,
                 args.upload_corpus, args.upload_coverage,
                 args.experiment_name, args.upload_reproducer, args.tags,
                 args.use_cached_image, args.real_project)
