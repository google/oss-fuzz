# Build Analysis and Report for `base-builder-rust`
...
1.  The existing `Dockerfile` was renamed to `ubuntu20-04.Dockerfile`.
2.  A new `ubuntu24-04.Dockerfile` was created.
