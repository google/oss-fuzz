...
if [[ "$VERSION_ID" == "20.04" ]]; then
  SWIFT_PACKAGES="wget \
            ...
            tzdata \
            zlib1g-dev"
  SWIFT_URL="https://download.swift.org/swift-5.10.1-release/ubuntu2004/swift-5.10.1-RELEASE/swift-5.10.1-RELEASE-ubuntu20.04.tar.gz"
  SWIFT_DIR="swift-5.10.1-RELEASE-ubuntu20.04"
