...
def is_suffix_match(needle: str, haystack: str):
  haystack_path, haystack_suffix = haystack.split(':', 1)
  needle_path, needle_suffix = needle.split(':', 1)
  haystack_path = os.path.abspath(haystack_path)
  needle_path = os.path.abspath(needle_path)
  return needle_path == haystack_path and needle_suffix == haystack_suffix
...
def parse_dependency_file(file_path: str, output_file: str,
  ...
  try:
    is_suffix_match(lines[0], output_file_line), (f"{lines[0]} is not a suffix of"
