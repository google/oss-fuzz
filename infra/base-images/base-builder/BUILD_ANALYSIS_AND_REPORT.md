...
#1 [internal] load build definition from ubuntu20-04.Dockerfile
#1 transferring dockerfile: 9.67kB done
#1 DONE 0.0s

#2 [internal] load metadata for gcr.io/oss-fuzz-base/base-clang:ubuntu20.04
#2 DONE 0.0s
...
#6 [stage-0  1/32] FROM gcr.io/oss-fuzz-base/base-clang:ubuntu20.04
#6 DONE 0.0s
...
#43 naming to docker.io/library/base-builder:ubuntu20.04 done
#43 DONE 0.0s
...
#1 [internal] load build definition from ubuntu24-04.Dockerfile
#1 transferring dockerfile: 8.34kB done
#1 DONE 0.0s

#2 [internal] load metadata for docker.io/library/base-clang:ubuntu24.04
#2 DONE 0.0s
...
#5 [stage-0  1/27] FROM docker.io/library/base-clang:ubuntu24.04
#5 CACHED
