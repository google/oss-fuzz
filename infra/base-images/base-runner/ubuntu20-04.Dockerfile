...
FROM gcr.io/oss-fuzz-base/base-image:ubuntu20.04 as temp-runner-binary-builder
...
FROM gcr.io/oss-fuzz-base/base-clang:ubuntu20.04 AS base-clang
FROM gcr.io/oss-fuzz-base/base-builder-ruby:ubuntu20.04 AS base-ruby
...
FROM gcr.io/oss-fuzz-base/base-builder:ubuntu20.04 AS base-builder

# Real image that will be used later.
FROM gcr.io/oss-fuzz-base/base-image:ubuntu20.04
