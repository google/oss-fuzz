...
This was resolved by editing both `ubuntu20-04.Dockerfile` and `ubuntu24-04.Dockerfile` to remove the `infra/base-images/base-runner/` prefix from all `COPY` commands, making the paths relative to the build context.
