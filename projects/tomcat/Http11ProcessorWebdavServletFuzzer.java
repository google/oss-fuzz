...
public class Http11ProcessorWebdavServletFuzzer {
    ...
    public static void fuzzerTestOneInput(FuzzedDataProvider data) {
        ...
        try {
            ...
            // Write the headers 
//            writer.write("POST " + str + " HTTP/1.1\r\n");
            ...
            throw new FuzzerSecurityIssueHigh("Should only be IOException.");
        }
    }
