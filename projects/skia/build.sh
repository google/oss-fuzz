...
cp $SRC/skia-artifacts/region_set_path_seed_corpus.zip $OUT/region_set_path_seed_corpus.zip

cp out/Fuzz/textblob_deserialize $OUT/textblob_deserialize
cp $SRC/skia-artifacts/textblob_deserialize_seed_corpus.zip $OUT/textblob_deserialize_seed_corpus.zip

cp out/Fuzz/path_deserialize $OUT/path_deserialize
cp $SRC/skia-artifacts/path_deserialize_seed_corpus.zip $OUT/path_deserialize_seed_corpus.zip

cp out/Fuzz/image_decode $OUT/image_decode
cp $SRC/skia-artifacts/image_decode_seed_corpus.zip $OUT/image_decode_seed_corpus.zip

cp out/Fuzz/animated_image_decode $OUT/animated_image_decode
cp $SRC/skia-artifacts/animated_image_decode_seed_corpus.zip $OUT/animated_image_decode_seed_corpus.zip

cp out/Fuzz_mem_constraints/image_filter_deserialize $OUT/image_filter_deserialize
cp $SRC/skia-artifacts/image_filter_deserialize_seed_corpus.zip $OUT/image_filter_deserialize_seed_corpus.zip
...
then
  ...
  cp $SRC/skia-artifacts/image_filter_deserialize_width.options $OUT/image_filter_deserialize_width.options
  # Use the same seed corpus as image_filter_deserialize.
  cp $SRC/skia-artifacts/image_filter_deserialize_seed_corpus.zip $OUT/image_filter_deserialize_width_seed_corpus.zip
fi

cp out/Fuzz/api_draw_functions $OUT/api_draw_functions
cp $SRC/skia-artifacts/api_draw_functions_seed_corpus.zip $OUT/api_draw_functions_seed_corpus.zip

cp out/Fuzz/api_gradients $OUT/api_gradients
cp $SRC/skia-artifacts/api_gradients_seed_corpus.zip $OUT/api_gradients_seed_corpus.zip

cp out/Fuzz/api_path_measure $OUT/api_path_measure
cp $SRC/skia-artifacts/api_path_measure_seed_corpus.zip $OUT/api_path_measure_seed_corpus.zip

cp out/Fuzz/api_pathop $OUT/api_pathop
cp $SRC/skia-artifacts/api_pathop_seed_corpus.zip $OUT/api_pathop_seed_corpus.zip

cp out/Fuzz/png_encoder $OUT/png_encoder
cp $SRC/skia-artifacts/encoder_seed_corpus.zip $OUT/png_encoder_seed_corpus.zip

cp out/Fuzz/jpeg_encoder $OUT/jpeg_encoder
cp $SRC/skia-artifacts/encoder_seed_corpus.zip $OUT/jpeg_encoder_seed_corpus.zip

cp out/Fuzz/webp_encoder $OUT/webp_encoder
cp $SRC/skia-artifacts/encoder_seed_corpus.zip $OUT/webp_encoder_seed_corpus.zip
...
cp $SRC/skia-artifacts/canvas_seed_corpus.zip $OUT/api_mock_gpu_canvas_seed_corpus.zip

cp out/Fuzz_mem_constraints/api_raster_n32_canvas $OUT/api_raster_n32_canvas
cp $SRC/skia-artifacts/canvas_seed_corpus.zip $OUT/api_raster_n32_canvas_seed_corpus.zip

cp out/Fuzz/api_image_filter $OUT/api_image_filter
cp $SRC/skia-artifacts/api_image_filter_seed_corpus.zip $OUT/api_image_filter_seed_corpus.zip

cp out/Fuzz/api_null_canvas $OUT/api_null_canvas
cp $SRC/skia-artifacts/canvas_seed_corpus.zip $OUT/api_null_canvas_seed_corpus.zip

cp out/Fuzz/api_polyutils $OUT/api_polyutils
cp $SRC/skia-artifacts/api_polyutils_seed_corpus.zip $OUT/api_polyutils_seed_corpus.zip

# These 2 can use the same corpus as the (non animated) image_decode.
cp out/Fuzz/android_codec $OUT/android_codec
cp $SRC/skia-artifacts/image_decode_seed_corpus.zip $OUT/android_codec_seed_corpus.zip.

cp out/Fuzz/image_decode_incremental $OUT/image_decode_incremental
cp $SRC/skia-artifacts/image_decode_seed_corpus.zip $OUT/image_decode_incremental_seed_corpus.zip

cp out/Fuzz/sksl2glsl $OUT/sksl2glsl
cp $SRC/skia-artifacts/sksl_seed_corpus.zip $OUT/sksl2glsl_seed_corpus.zip

cp out/Fuzz/sksl2spirv $OUT/sksl2spirv
cp $SRC/skia-artifacts/sksl_seed_corpus.zip $OUT/sksl2spirv_seed_corpus.zip

cp out/Fuzz/sksl2metal $OUT/sksl2metal
cp $SRC/skia-artifacts/sksl_seed_corpus.zip $OUT/sksl2metal_seed_corpus.zip

cp out/Fuzz/sksl2pipeline $OUT/sksl2pipeline
cp $SRC/skia-artifacts/sksl_seed_corpus.zip $OUT/sksl2pipeline_seed_corpus.zip
...
cp $SRC/skia-artifacts/api_polyutils_seed_corpus.zip $OUT/skdescriptor_deserialize_seed_corpus.zip

cp out/Fuzz/svg_dom $OUT/svg_dom
cp $SRC/skia-artifacts/svg_dom_seed_corpus.zip $OUT/svg_dom_seed_corpus.zip

cp out/Fuzz/api_svg_canvas $OUT/api_svg_canvas
cp $SRC/skia-artifacts/canvas_seed_corpus.zip $OUT/api_svg_canvas_seed_corpus.zip

cp out/Fuzz/skruntimeeffect $OUT/skruntimeeffect
cp $SRC/skia-artifacts/sksl_with_256_padding_seed_corpus.zip $OUT/skruntimeeffect_seed_corpus.zip

cp out/Fuzz/api_create_ddl $OUT/api_create_ddl

cp out/Fuzz/skp $OUT/skp
cp $SRC/skia-artifacts/skp_seed_corpus.zip $OUT/skp_seed_corpus.zip
