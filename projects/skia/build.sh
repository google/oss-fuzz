...
$SRC/depot_tools/ninja -C out/Fuzz_mem_constraints image_filter_deserialize api_raster_n32_canvas api_mock_gpu_canvas
$SRC/depot_tools/ninja -C out/Fuzz region_deserialize region_set_path \
                                   ...
                                   skjson api_null_canvas api_image_filter
