...
outexe=${outfile%.*}
echo $outexe
/usr/local/bin/clang-15 -isystem /usr/local/lib/clang/15.0.0/include -isystem /usr/local/include -isystem /usr/include/x86_64-linux-gnu -isystem /usr/include -fsanitize=address -fsanitize=fuzzer -O1 -fno-omit-frame-pointer -gline-tables-only -DFUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION -fsanitize=address -fsanitize-address-use-after-scope -fsanitize=fuzzer-no-link -O1 -fno-omit-frame-pointer -gline-tables-only -DFUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION -fsanitize=address -fsanitize-address-use-after-scope -fsanitize=fuzzer-no-link -pthread -I/work/prefix/include -I/work/prefix/include/gdk-pixbuf-2.0 -I/work/prefix/include -I/work/prefix/include/glib-2.0 -I/work/prefix/lib/glib-2.0/include $outfile -Wl,-Bdynamic -ldl -lm -lc -pthread -lrt -lpthread -Wl,-static -L/work/prefix/lib -Wl,--export-dynamic -lgdk_pixbuf-2.0 -lm -lpng16 -ljpeg -lgio-2.0 -pthread -lresolv -lgobject-2.0 -pthread -lffi -lgmodule-2.0 -pthread -lglib-2.0 -pthread -lz -fsanitize=fuzzer -Wl,-Bdynamic -o $outexe
cp $outexe /out/
done
