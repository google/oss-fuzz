...
javac -cp $SRC:$BUILD_CLASSPATH -g $SRC/apache-commons-collections/*.java
cp $SRC/apache-commons-collections/*.class $OUT/

for fuzzer in $(find $SRC/apache-commons-collections -name '*Fuzzer.java'); do
