...
pushd "$SRC/commons-configuration"
...
cp $SRC/apache-commons-configuration/ini.dict $OUT/INIConfigurationReadFuzzer.dict
cp $OUT/INIConfigurationReadFuzzer.dict $OUT/INIConfigurationWriteFuzzer.dict
...
for fuzzer in $(find $SRC/apache-commons-configuration -iname '*Fuzzer.java'); do
    fuzzer_basename=$(basename -s .java $fuzzer)
    javac -cp $BUILD_CLASSPATH $fuzzer
    cp $SRC/apache-commons-configuration/$fuzzer_basename.class $OUT/
